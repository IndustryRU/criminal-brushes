...
На 2026-07-14 эта версия Flutter включает Dart `3.12.2`.
...
Flutter skeleton создан в `apps/customer_app`; команды запускаются из этой папки через корневой FVM SDK.
